...
No data has crossed the boundary yet — Phase 47b writes the redacted events to the local staging tree only; the SessionEnd push cadence + git push land in 47c. Full schema + trust model: `docs/INSTALLATION.md` § Share mode opt-in.
